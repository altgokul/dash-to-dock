...
const dockedDash = new Lang.Class({
    ...
    _init: function(settings) {
        ...
        this._box = new St.BoxLayout({ name: 'dashtodockBox', reactive: true, track_hover:true, /*mych */ clip_to_allocation: true } );
        /*mych*/
        this.dash._box = this._box;
        this._box.set_height(Main.panel.actor.get_height());
